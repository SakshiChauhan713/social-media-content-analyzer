...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-pink-50 via-purple-50 to-indigo-50 flex items-center justify-center p-6">
      {/* Toast */}
      {toast && (
      ...
      {/* Card */}
      <div className="bg-gradient-to-br from-white via-pink-50 to-purple-50 rounded-2xl shadow-xl w-full max-w-4xl p-8">
        {/* Heading */}
